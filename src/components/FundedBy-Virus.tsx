...
export function FundedBy() {
  return (
    <section className="mx-auto w-full max-w-[100rem] px-4 sm:px-6 lg:px-8" aria-label="Funding and institutional support">
      <p className="text-center text-xs font-semibold uppercase tracking-[0.3em] text-slate-500">Funded by</p>
      <div className="mt-8 flex flex-col flex-wrap items-center justify-center gap-16 border-t border-white/[0.06] pt-10 sm:flex-row sm:gap-24 lg:gap-32">
        {fundingPartners.map((partner) => (
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="relative block shrink-0 opacity-90 transition hover:opacity-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-blue-400"
          >
            <Image
              src={partner.src}
              alt={partner.name}
